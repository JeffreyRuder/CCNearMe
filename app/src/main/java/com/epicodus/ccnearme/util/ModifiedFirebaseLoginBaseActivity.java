 ...
 * activity.
 */
public abstract class ModifiedFirebaseLoginBaseActivity extends AppCompatActivity {

    private final String TAG = "FirebaseLoginBaseAct";

    private Firebase.AuthStateListener mAuthStateListener;
    private AuthData mAuthData;
    private ModifiedFirebaseLoginDialog mDialog;
    ...
    protected void onStart() {
        ...
        mDialog = new ModifiedFirebaseLoginDialog();
        mDialog
                .setContext(this)
