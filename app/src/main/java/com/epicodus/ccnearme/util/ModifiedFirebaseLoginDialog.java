...
public class ModifiedFirebaseLoginDialog extends FirebaseLoginDialog {
...
//            }
        ...
        //Hide views for disabled login providers. Uncomment above section to restore original login behavior.
        mView.findViewById(R.id.password_section).setVisibility(View.GONE);
        mView.findViewById(R.id.twitter_button).setVisibility(View.GONE);
